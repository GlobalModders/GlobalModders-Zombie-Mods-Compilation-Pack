...
#define PLUGIN "[ZBHeroEx] Melee: Dragon Sword"
#define VERSION "1.0"
#define AUTHOR "Dias Leon"

#define V_MODEL "models/zombie_thehero/weapon/melee/v_dragonsword2.mdl"
#define P_MODEL "models/zombie_thehero/weapon/melee/p_dragonsword.mdl"

#define CSW_DRAGONSWORD CSW_KNIFE
#define weapon_dragonsword "weapon_knife"
#define WEAPON_ANIMEXT "skullaxe"

#define DRAW_TIME 1.0

#define SLASH_ROTATE_DAMAGE 550.0
...
#define SLASH_AHEAD_DAMAGE 800.0
...
public plugin_init()
{
	...
	RegisterHam(Ham_Item_Deploy, weapon_dragonsword, "fw_Item_Deploy_Post", 1)
}
...
public plugin_precache()
{
	...
	g_DragonSword = zbheroex_register_weapon("Green Dragon Glaive", WEAPON_MELEE, CSW_KNIFE, 4999)
}
...
public Event_CurWeapon(id)
{
	...
	if(get_user_weapon(id) == CSW_DRAGONSWORD && g_Old_Weapon[id] != CSW_DRAGONSWORD)
	{
		set_weapon_anim(id, DS_ANIM_DRAW)
		set_player_nextattack(id, DRAW_TIME)
	}
