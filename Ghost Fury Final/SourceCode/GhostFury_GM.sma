...
new g_MaxPlayers, g_Joined, g_MsgScoreInfo, g_MsgSayText, g_MsgFog, g_MsgScreenFade,
...
Float:SoundDelay_Notice, m_iBlood[2], g_Falling, g_Cvar_RoundTime, Float:g_RoundTimeLeft, 
...
public Native_SetKamui(id, On)
{
	...
	if(On)
	{
		...
		GM_Set_PlayerModel(id, g_GhostModelNC)
		GM_Set_PlayerSpeed(id, g_GhostSpeedNC, 1)
		
		Set_BitVar(g_UsingKamui, id)
	} else {
		set_user_noclip(id, 0)
		GM_Set_PlayerModel(id, g_GhostModel)
		GM_Set_PlayerSpeed(id, g_GhostSpeed, 1)
		
		UnSet_BitVar(g_UsingKamui, id)
	}
}

public Native_SetSpeed(id, Float:Speed, BlockSpeed) GM_Set_PlayerSpeed(id, Speed, BlockSpeed)
...
public Event_RoundStart()
{
	...
	set_task(get_pcvar_float(g_Cvar_RoundTime) * 60.0, "Event_TimeUp", 1840)
...
public fw_PlayerSpawn_Post(id)
{
	...
	GM_Set_PlayerModel(id, g_PlayerModel[id])
