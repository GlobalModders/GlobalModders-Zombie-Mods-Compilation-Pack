...
{
	// Primary
	g_Pri_M4A1 = gf_weapon_register("M4A1 Carbine", WPN_PRIMARY, CSW_M4A1, 0)
	g_Pri_AK47 = gf_weapon_register("AK-47 Kalashnikov", WPN_PRIMARY, CSW_AK47, 0)
	g_Pri_AUG = gf_weapon_register("Steyr AUG A1", WPN_PRIMARY, CSW_AUG, 0)
	g_Pri_SG552 = gf_weapon_register("SG-552 Commando", WPN_PRIMARY, CSW_SG552, 0)
	g_Pri_Galil = gf_weapon_register("IMI Galil", WPN_PRIMARY, CSW_GALI, 0)
	g_Pri_M3 = gf_weapon_register("M3 Super 90", WPN_PRIMARY, CSW_M3, 0)
	g_Pri_XM1014 = gf_weapon_register("XM1014 M4", WPN_PRIMARY, CSW_XM1014, 0)
	g_Pri_AWP = gf_weapon_register("AWP Magnum Sniper", WPN_PRIMARY, CSW_AWP, 0)
	g_Pri_Scout = gf_weapon_register("Schmidt Scout", WPN_PRIMARY, CSW_SCOUT, 0)
	g_Pri_Famas = gf_weapon_register("Famas", WPN_PRIMARY, CSW_FAMAS, 0)
	g_Pri_MP5 = gf_weapon_register("MP5 Navy", WPN_PRIMARY, CSW_MP5NAVY, 0)
	g_Pri_P90 = gf_weapon_register("ES P90", WPN_PRIMARY, CSW_P90, 0)
	g_Pri_UMP45 = gf_weapon_register("UMP 45", WPN_PRIMARY, CSW_UMP45, 0)
	g_Pri_MAC = gf_weapon_register("Ingram MAC-10", WPN_PRIMARY, CSW_MAC10, 0)
	g_Pri_TMP = gf_weapon_register("Schmidt TMP", WPN_PRIMARY, CSW_TMP, 0)
	
	// Secondary
	g_Sec_USP = gf_weapon_register("USP .45 ACP Tactical", WPN_SECONDARY, CSW_USP, 0)
	g_Sec_Glock18 = gf_weapon_register("Glock 18C", WPN_SECONDARY, CSW_GLOCK18, 0)
	g_Sec_DE = gf_weapon_register("Desert Eagle .50 AE", WPN_SECONDARY, CSW_DEAGLE, 0)
	g_Sec_P228 = gf_weapon_register("P228 Compact", WPN_SECONDARY, CSW_P228, 0)
	g_Sec_FiveSeven = gf_weapon_register("FiveseveN", WPN_SECONDARY, CSW_FIVESEVEN, 0)
	g_Sec_DualElite = gf_weapon_register("Dual Elite Berettas", WPN_SECONDARY, CSW_ELITE, 0)
	
	// Melee
	g_Melee_SealKnife = gf_weapon_register("Seal Knife", WPN_MELEE, CSW_KNIFE, 0)
}

public gf_weapon_bought(id, ItemID)
{
	...
	if(ItemID != g_Melee_SealKnife) Give_FuckingAmmo(id, gf_weapon_get_cswid(id, ItemID), 0)
}

public gf_weapon_addammo(id, ItemID)
{
	Give_FuckingAmmo(id, gf_weapon_get_cswid(id, ItemID), 0)
}
