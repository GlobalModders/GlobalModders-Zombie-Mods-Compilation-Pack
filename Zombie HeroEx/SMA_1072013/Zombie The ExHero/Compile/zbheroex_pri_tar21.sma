...
#define PLUGIN "[ZBHeroEx] Primary: TAR-21"
#define VERSION "1.0"
#define AUTHOR "Dias"

#define V_MODEL "models/zombie_thehero/weapon/pri/v_tar21.mdl"
#define P_MODEL "models/zombie_thehero/weapon/pri/p_tar21.mdl"
#define W_MODEL "models/zombie_thehero/weapon/pri/w_tar21.mdl"
...
public plugin_precache()
{
	...
	g_Weapon = zbheroex_register_weapon("TAR-21", WEAPON_PRIMARY, CSW_BASEDON, 0)
}
...
public fw_TraceAttack_Player(Victim, Attacker, Float:Damage, Float:Direction[3], Ptr, DamageBits)
{
	...
	if(is_user_alive(Victim) && zbheroex_get_user_zombie(Victim))
	{
		static Float:Origin[3]
		pev(Attacker, pev_origin, Origin)
		
		hook_ent2(Victim, Origin, 100.0, 1.0, 2)
	}
